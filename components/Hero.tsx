...
export const Hero: React.FC<HeroProps> = ({ name, tagline, contact, heroImageUrl, showHeroImage, cvUrl }) => {
  return (
    <header className="py-24 md:py-32 text-center relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="mt-12">
          <a 
            href={cvUrl} 
            download="Mahir_Faisal_CV.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-cyan-600 text-white font-bold text-lg py-3 px-8 rounded-lg hover:bg-cyan-500 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/20"
          >
